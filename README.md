...
一套基于 LLM 的动态叙事引擎的 SillyTavern / TauriTavern 插件（当前版本 v1.1.1）。
...
- **主题切换**：页脚主题按钮可切换皮肤——「古风典雅」（默认，宣纸底 + 墨色描边 + 朱砂印章 + 鎏金点缀，楷体字，仿 SoulLink 同款主题）、「macOS 风格」（玻璃 / 圆角 / 蓝紫强调，亮暗自适应）与「手绘涂鸦」（白纸 + 圆珠笔涂鸦笔记本风，全直角方方正正，手写字体），选择后即时生效并持久化。
